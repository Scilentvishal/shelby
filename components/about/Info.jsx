...
const info = () => {
  return (
    <div className="py-2 md:px-10 px-1 text-start">
      ...
      <p className="text-white text-xl">
        ...
        prodigy in make up art. Her passion and love for flawless makeup no
        doubt makes her stand out exceptionally and unmatched in the field of
        the makeup industry.
      </p>
      <br />
      <p className="text-white text-xl">
        ...
        nuances of makeup artistry and the ability to demonstrate the dramatic
        beauty transformations. Shelby designed and tailored comprehensive
        makeup courses for her students which helped them kick start their
        career.{' '}
      </p>
      <br />
    </div>

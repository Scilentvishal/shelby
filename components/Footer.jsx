      ...
      <div className="container px-5 py-24 mx-auto max-w-screen-xl">
        <div className="flex flex-wrap md:text-left text-center order-first">
          <div className="lg:w-1/4 sm:w-1/2 w-full px-4">
            <h2 className="title-font font-medium text-white trackingWidest text-sm mb-3">
              CATEGORIES
            </h2>
            ...
            <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
              <div className="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
                ...
                <input
                  ...
                  id="footer-field"
                  name="footer-field"
                  className="w-full bg-dwhite bg-opacity-50 rounded border border-dwhite focus:bg-transparent focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base outline-none text-white py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                />
              </div>
